...
if __name__ == "__main__":
    ...
    if DEVELOP_MODE:
        ...
        history_path = '../../'
    if opt.num_pe < 1 or opt.num_pe > 10000:
        raise ValueError(f"Invalid PE count {opt.num_pe} - use 1-10000")
    ...
    try:
        ...
        # train_model_tabu(model_defs, input_arg=opt, map_cstr=map_cstr, chkpt_file=chkpt_file)
